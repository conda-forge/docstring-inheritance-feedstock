...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/docstring-inheritance-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14478&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/docstring-inheritance-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `docstring-inheritance` can be installed with:

```
conda install docstring-inheritance
```

It is possible to list all of the versions of `docstring-inheritance` available on your platform with:
